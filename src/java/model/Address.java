...
public class Address implements Serializable {
     ...
     * to designate the location of an where an
     * event is happening in our app.
     * @param line1 first line of an address
     * @param line2 second line of an address (if needed)
     * @param city city address is located in
     * @param state state address is located in
     * @param ZIP zipcode address is located in
     */
